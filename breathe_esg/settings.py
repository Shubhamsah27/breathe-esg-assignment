...
SECRET_KEY = 'django-insecure-br(e)athe-esg-assignment-key-2026'
...
# Use persistent disk folder on Render if available, otherwise fallback to local BASE_DIR
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Prototype permissions
    ],
